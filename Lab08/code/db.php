<?php
//Добавил пару проверок, они помогают сразу найти обработку пост-запросов
//отформатировал строки и отступы
//некоторые действия, например закрытие результата, для ясности убрал прям в самый
//конец функций
